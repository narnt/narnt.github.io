let proverbs = new Array('— Распишитесь, пожалуйста.', '— Но это не мой паспорт! Я не Аннет Михельсон!', '— Вы что, вместе с паспортом память потеряли? Здесь ваши данные, осталась только подпись.', '');
