var proverbs=new Array('Дверь заперта на один оборот, значит, сестра уже дома и, скорее всего, спит. Оборачиваюсь — вот и рассвет…');
var audio = document.createElement("audio");
var canPlayMmp3 = !!audio.canPlayType && audio.canPlayType('audio/mp3') != "";
if(!canPlayMmp3) {
 audio.src = "../music/bloom.ogg";
}
  audio.src = "../music/bloom.mp3";
  audio.loop = true;
  audio.play();
  function fading() {
